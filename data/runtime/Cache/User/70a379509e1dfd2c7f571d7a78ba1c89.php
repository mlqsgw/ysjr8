...
<div class="long_uc f_l">
   ...
   <div class="list">
	<div class="list_title clearfix">
		<div class="cur"><a href="<?php echo U('User/Myaccount/authphone');?>">手机认证</a></div>
	</div>
		...
		<div class="inc_main">
			<div class="tip-h clearfix">
				<div class="lh22 f14" style="margin-bottom:20px;padding-left:107px;padding-top:50px;">
					...
					<?php if(($cellphone_audit) == "0"): ?><p>尚未申请手机认证</p>
	              			<p>若您希望申请手机认证，请点击申请认证：</p><?php endif; ?>
	                
					<?php if(($cellphone_audit) == "1"): ?><p>已绑定手机号：<?php echo ($cellphone); ?></p>
		                <p>若您希望重新绑定其他手机号，请输入以下信息：</p><?php endif; ?>
					<?php if(($cellphone_audit) == "2"): ?><p>手机认证正在审核中......</p><?php endif; ?>
					<?php if(($cellphone_audit) == "3"): ?><p>手机认证审核失败</p>
	              			<p>若您希望申请手机认证，请点击申请认证：</p><?php endif; ?>
						            </div>
				<if condition="$video_audit neq 2">
				<form id="j_bind_mobile"method="post" name="bind_mobile" action="<?php echo U('User/Myaccount/authphone');?>">
