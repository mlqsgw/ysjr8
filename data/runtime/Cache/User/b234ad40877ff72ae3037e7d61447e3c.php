...
<script type="text/javascript" src="/tpl/simplebootx/Public/js/jquery.pm.js"></script>
...
<div class="uc_r_bl">
    ...
    <div class="list_cont clearfix">
        <table width="100%" border="0" cellspacing="1px" class="credit" style="margin:10px auto">
            <tbody>
            ...
            <tr>
                ...
                <td><img alt="AA" src="/data/upload/Level/54cc43042014a.png" width="30" height="30"></td>
                <td><img alt="A" src="/data/upload/Level/54cc42f0a6a98.png" width="30" height="30"></td>
                <td><img alt="B" src="/data/upload/Level/54cc42dd220cd.png" width="30" height="30"></td>
                <td><img alt="C" src="/data/upload/Level/54cc42464f787.png" width="30" height="30"></td>
                <td><img alt="D" src="/data/upload/Level/54cc43042014a6.png" width="30" height="30"></td>
                <td><img alt="E" src="/data/upload/Level/553f457f83377.png" width="30" height="30"></td>
                <td><img alt="HR" src="/data/upload/Level/54cc4141349fe.png" width="30" height="30"></td>
            </tr>
            <tr>
                <td>信用分数</td>
                <td>
                    160及以上<?php echo ($riririrri); ?>
                </td>
                <td>
                    159-145
                </td>
        ...
        <table width="100%" align="center" border="0" cellspacing="1px" class="credit">
            <tbody>
            <tr class="title">
                <td colspan="4" class="f14 b f_dgray">
                    信用总分（等级）：20 （HR）
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;信用额度：0 ( 可用额度：0 )
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="f_gray"></td>
                <td class="white_bg"><span class="f_red"><?php echo ($integral[7]['value']); ?></span>分</td>
            </tr>

            <tr>
                <td rowspan="2" class="white_bg b">必要信用认证</td>
                <td class="white_bg item">
                    <p><a class="uc_cate" href="<?php echo U('User/Myaccount/authphone');?>" title="手机认证">手机认证</a></p>
                </td>
                <td class="white_bg f_gray">
				
                    <?php if(($autd['cellphone_audit'] == 0)): ?>待完成
                 <?php elseif(($autd['cellphone_audit'] == 1)): ?>认证通过
                 <?php elseif(($autd['cellphone_audit'] == 2)): ?>等待审核                 
                 <?php elseif(($autd['cellphone_audit'] == 3)): ?>审核失败<?php endif; ?>
                </td>
                <td  class="white_bg"><span class="f_red"><?php echo ($integral[2]['value']); ?></span>分</td>
            </tr>
            <!-- 
            <tr>
                <td class=" item">邮箱认证</td>
                <td class="f_gray">
                    <img src="http://www.fanwei.com/app/Tpl/blue/images/credit_warning.png" width="32px" height="32px"
                         alt="待完成" title="待完成">
                </td>
                <td  class="white_bg"><span class="f_red"><?php echo ($integral[4]['value']); ?></span>分</td>
            </tr>
             -->
            <tr>
                <td class="white_bg"><a class="uc_cate" href="<?php echo U('User/Myaccount/index');?>" title="实名认证">实名认证</a></td>
                <td class="white_bg f_gray">
                     <?php if(($autd['wechat_audit'] == 0)): ?>待完成
                 <?php elseif(($autd['wechat_audit'] == 1)): ?>认证通过
                 <?php elseif(($autd['wechat_audit'] == 2)): ?>等待审核                 
                 <?php elseif(($autd['wechat_audit'] == 3)): ?>审核失败<?php endif; ?>
                </td>
                <td  class="white_bg"><span class="f_red"><?php echo ($integral[3]['value']); ?></span>分</td>
            </tr>
            <!--<tr>
                <td class="item"><a class="uc_cate" href="<?php echo U('User/Myaccount/authvodie');?>" title="视频认证">视频认证</a></td>
                <td class="f_gray'">
                    <img src="http://www.fanwei.com/app/Tpl/blue/images/credit_warning.png" width="32px" height="32px"
                         alt="待完成" title="待完成">
                </td>
                <td  class="white_bg"><span class="f_red"><?php echo ($integral[6]['value']); ?></span>分</td>
            </tr>
            <tr>
                <td class="item"><a class="uc_cate" href="<?php echo U('User/Myaccount/authsite');?>" title="现场认证">现场认证</a></td>
                <td class="f_gray'">
                    <img src="http://www.fanwei.com/app/Tpl/blue/images/credit_warning.png" width="32px" height="32px"
                         alt="待完成" title="待完成">
                </td>
                <td  class="white_bg"><span class="f_red"><?php echo ($integral[5]['value']); ?></span>分</td>
            </tr>-->

            <?php if(is_array($Review)): foreach($Review as $k=>$vo): ?><tr>
                    <?php if(($k) == "0"): ?><td rowspan="<?php echo ($Reviewcoun); ?>" class="item">可选信用认证</td><?php endif; ?>
                    <td class="white_bg item"><?php echo ($vo["name"]); ?></td>
                    <td class="white_bg f_gray">
                    	<?php if($vo['state'] == -1 ): ?><a href="<?php echo U('User/Audit/DataAuth',array('mid'=>$vo['id']));?>"> <img src="http://www.fanwei.com/app/Tpl/blue/images/credit_warning.png" width="32px" height="32px"
                             alt="待完成" title="待完成"></a>
                         <?php elseif($vo['state'] == 1): ?>
                          ...
                          <?php elseif($vo['state'] == 0): ?>
                          	正在审核中
                          <?php else: ?>
                         <a href="<?php echo U('User/Audit/DataAuth',array('mid'=>$vo['id']));?>">   未通过 </a><?php endif; ?>    
                    </td>
                    <td  class="white_bg"><span class="f_red"><?php echo ($vo["source"]); ?></span>分</td>
            ...
            <tr>
                <td rowspan="3" class="b white_bg">p2p信贷记录</td>
                <td class="item">
                    还清笔数（+1分/笔，加分间隔28天，上限20分）
                </td>
                <td class="f_gray">
                    0 笔
                </td>
            ...
            <tr class="">
                ...
                <td class="white_bg f_gray">0 次</td>
                <td class="white_bg"><span class="f_red"> 0 </span> 分</td>
            </tr>
            <tr class="">
                <td class="item">严重逾期次数（-30分/次）</td>
                <td class="f_gray">0 次</td>
                <td><span class="f_red"> 0 </span> 分</td>
            </tr>
            </tbody>
        </table>
    </div>
