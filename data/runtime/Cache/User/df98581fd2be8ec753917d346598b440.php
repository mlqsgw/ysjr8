...
<div class="long_uc f_l">
	...
	<div class="cont homeBg">
	    ...
	    <div class="clearfix lh22" style="background-color:#E47F2B;height:30px;vertical-align:middle"></div>
	    <div class="desc clearfix pt10 mt10 mb15 ml20">
	        <!--<div class="toux f_l pr30" style="width:132px;">
	            <div>
	            <?php if(empty($user['avatar'])): ?><img class="img_b" style="margin:25px 0 0 0;"  src="/tpl/simplebootx/Public/images/noavatar_middle.gif" type="big" width="120px" height="120px" alt="<?php echo ($user_login); ?>" title="<?php echo ($user_login); ?>">
	            <?php else: ?>
	            <img class="img_b" style="margin:25px 0 0 0;"  src="<?php echo sp_get_user_avatar_url($user['avatar']);?>" type="big" width="120px" height="120px" alt="<?php echo ($user["user_login"]); ?>" title="<?php echo ($user["user_login"]); ?>"><?php endif; ?>
	            </div>
	        </div>-->
			
            <div class="f_l f_dgray" style="padding-left:0px;">
                <div class="lh24 u_name" style="height:24px; margin-bottom:16px;">
                    <div class="f_l">
                        <?php echo ($user["user_login"]); ?>	                </div>
                    <a href="<?php echo U('User/Myaccount/index');?>">（修改个人资料）</a>
                </div>
                <div class="user_desc desc_lf">
                    <ul>
                        <li>
                            <span>资金余额：</span><?php echo ($money["total_money"]); ?>元            		</li>
						<li>
                            <span>所在地：</span><?php echo ($address); ?>
                        </li>
                    </ul>
                </div>
                <div class="user_desc desc_rt">
                    <ul>
                        <li>
                            <span>可用资金：</span><?php echo ($money["available_funds"]); ?>元	            		</li>
                        <li>
                            <span>个人统计：</span> <?php echo ($loanlog); ?> 条借款记录， <?php echo ($lendlog); ?>条投标记录
                        </li>
                    </ul>
                </div>
            </div>
            <div class="f_r recharge">
                <a href="<?php echo U('User/Money/index',array('act'=>'incharge'));?>" class="rcg">充值</a>
                <a href="<?php echo U('User/Money/index',array('act'=>'bank'));?>" class="wdl">提现</a>
            </div>
...
<div <?php if(($act) == ""): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('User/Center/index');?>">我的最近动态</a></div>
<div <?php if(($act) == "deal"): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('User/Center/index',array('act'=>'deal'));?>">借款记录</a></div>
<div <?php if(($act) == "lend"): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('User/Center/index',array('act'=>'lend'));?>">投标记录</a></div>
        </div>
        <div class="uc_r_bl_box clearfix p10">
            <?php if(!empty($lists)): ?><div class="list_cont">
                <div class="i_deal_list clearfix">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr class="item <?php if(($mod) == "1"): ?>item_1<?php endif; ?>" >
            ...
            <div class="tc p15">暂无记录</div><?php endif; ?>
        </div>
    </div>
