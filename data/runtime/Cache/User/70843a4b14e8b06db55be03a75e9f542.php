...
<div <?php if(($act) == ""): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('User/Money/index');?>">账户日志</a></div>
<div <?php if(($act) == "incharge"): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('User/Money/index',array('act'=>'incharge'));?>">会员充值</a></div>
<div <?php if(($act) == "incharge_log"): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('User/Money/index',array('act'=>'incharge_log'));?>">充值日志</a></div>
<div <?php if(($act == 'bank') or ($act == 'bank_add') or ($act == 'carry')): ?>class="cur"<?php endif; ?> ><a href="<?php echo U('User/Money/index',array('act'=>'bank'));?>">会员提现</a></div>

	</div>
	<div class="uc_r_bl_box clearfix">
				<table border="0" cellspacing="1" class="oval_table">
					<tbody>
						<tr style="background:#E47F2B
; color:#fff; height:40px;">
						...
						<tr style="height:35px; background:#fff">
							...
							<td>￥<?php echo ($available_funds); ?></td>
							<td>￥<?php echo ($freeze_funds); ?></td>
						</tr>
					</tbody>
				</table>
			<div class="sub_nav">
				<!--<span class="act"><a href="">全部</a></span>
				<span ><a href="">信用</a></span>-->
				<span class="act"><a href="<?php echo U('user/money/index',array('act'=>'index'));?>">资金</a></span>
			...
			<table border="0" cellspacing="1" class="oval_table">
				<tbody>
					<tr style="background:#E47F2B
; color:#fff; height:40px;">
						<th style="width:17%">事件</th>
						<th style="width:17%">金额</th>												
                        <!--<th style="width:17%">信用</th>
                       	<th style="width:17%">额度</th>
                       	<th style="width:17%">冻结/提现</th>-->
                        <th style="width:15%">发生时间</th>
					</tr>
					<?php if(is_array($money_log)): foreach($money_log as $key=>$vo): ?><tr style="height:40px;">
							<td>
			<?php if($vo["type"] == 1): ?>充值<?php elseif($vo["type"] == 2): ?>冻结
			<?php elseif($vo["type"] == 3): ?>支付<?php elseif($vo["type"] == 4): ?>提现
			<?php elseif($vo["type"] == 5): ?>收款<?php elseif($vo["type"] == 6): ?>系统放款
			<?php elseif($vo["type"] == 7): ?>手续费<?php else: ?>恢复冻结资金<?php endif; ?>
							</td>
