...
<div class="long_uc f_l">
  ...
  <div class="list">
	<div class="list_title clearfix">
			...
			<div <?php if(($act_name) == "work"): ?>class="cur"<?php endif; ?>  ><a href="<?php echo U('User/Myaccount/work');?>">工作认证</a></div>
	</div>
	...
	<div class="blank"></div>
	<form method="post" action="<?php echo U('User/Myaccount/work');?>" name="modify">
	<div class="inc wb">
		<div class="inc_main">
				<div class="t_name item_group" style="width:840px">工作信息</div>
				<table width="840px" class="user_info_table">
					<tr>
						<td class="pt10">
							
							<div class="field office">
								<label for="settings-office"><span class="red">*</span>单位名称</label>
								<input type="text" value="<?php echo ($office); ?>" class="f-input" id="settings-office" name="office" size="30">
							</div>
							<div class="blank10"></div>
							<div class="field jobtype">
								<label for="settings-jobtype"><span class="red">*</span>职业状态</label>
								<select name="jobtype" id="settings-jobtype">
									<option value="">请选择</option>
									<option value="工薪阶层" <?php if(($jobtype) == "工薪阶层"): ?>selected="selected"<?php endif; ?>>工薪阶层</option>
									<option value="私营企业主" <?php if(($jobtype) == "私营企业主"): ?>selected="selected"<?php endif; ?>>私营企业主</option>
									<option value="网络商家" <?php if(($jobtype) == "网络商家"): ?>selected="selected"<?php endif; ?>>网络商家</option>
									<option value="其他" <?php if(($jobtype) == "其他"): ?>selected="selected"<?php endif; ?>>其他</option>
								</select>
							</div>	
							<div class="blank10"></div>									
							<div class="field">								
								<label for="settings-region"><span class="red">*</span>工作城市</label>
								    ...
								    <script type="text/javascript">
								    var natives = "<?php echo ($work_city1); ?>";
								    if(natives){
								    	var opt0 = ["<?php echo ($work_city1); ?>","<?php echo ($work_city2); ?>","<?php echo ($work_city3); ?>"];
								    }
								    _init_area();
								    </script>
							...
							<div class="field officetype">
								<label for="settings-officetype"><span class="red">*</span>公司类别</label>
								<select name="officetype" id="settings-officetype">
									<option value="">请选择</option>
									<option value="国家机关" <?php if(($officetype) == "国家机关"): ?>selected="selected"<?php endif; ?>>国家机关</option>
									<option value="事业单位" <?php if(($officetype) == "事业单位"): ?>selected="selected"<?php endif; ?>>事业单位</option>
									<option value="央企（包括下级单位）" <?php if(($officetype) == "央企（包括下级单位）"): ?>selected="selected"<?php endif; ?>>央企（包括下级单位）</option>
									<option value="地方国资委直属企业" <?php if(($officetype) == "地方国资委直属企业"): ?>selected="selected"<?php endif; ?>>地方国资委直属企业</option>
									<option value="世界500强（包括合资企业及下级单位）" <?php if(($officetype) == "世界500强（包括合资企业及下级单位）"): ?>selected="selected"<?php endif; ?>>世界500强（包括合资企业及下级单位）</option>
									<option value="外资企业（包括合资企业）" <?php if(($officetype) == "外资企业（包括合资企业）"): ?>selected="selected"<?php endif; ?>>外资企业（包括合资企业）</option>
									<option value="一般上市公司（包括国外上市）" <?php if(($officetype) == "一般上市公司（包括国外上市）"): ?>selected="selected"<?php endif; ?>>一般上市公司（包括国外上市）</option>
									<option value="一般民营企业" <?php if(($officetype) == "一般民营企业"): ?>selected="selected"<?php endif; ?>>一般民营企业</option>
								</select>
							</div>
							<div class="blank10"></div>
							<div class="field officedomain">
								<label for="settings-officedomain"><span class="red">*</span>公司行业</label>
								<select name="officedomain" id="settings-officedomain">
									<option value="">请选择</option>
									<option value="制造业" <?php if(($officedomain) == "制造业"): ?>selected="selected"<?php endif; ?>>制造业</option>
									<option value="IT" <?php if(($officedomain) == "IT"): ?>selected="selected"<?php endif; ?>>IT</option>
									<option value="政府机关" <?php if(($officedomain) == "政府机关"): ?>selected="selected"<?php endif; ?>>政府机关</option>
									<option value="媒体/广告" <?php if(($officedomain) == "媒体/广告"): ?>selected="selected"<?php endif; ?>>媒体/广告</option>
									<option value="零售/批发" <?php if(($officedomain) == "零售/批发"): ?>selected="selected"<?php endif; ?>>零售/批发</option>
									<option value="教育/培训" <?php if(($officedomain) == "教育/培训"): ?>selected="selected"<?php endif; ?>>教育/培训</option>
									<option value="公共事业" <?php if(($officedomain) == "公共事业"): ?>selected="selected"<?php endif; ?>>公共事业</option>
									<option value="交通运输业" <?php if(($officedomain) == "交通运输业"): ?>selected="selected"<?php endif; ?>>交通运输业</option>
									<option value="房地产业" <?php if(($officedomain) == "房地产业"): ?>selected="selected"<?php endif; ?>>房地产业</option>
									<option value="能源业" <?php if(($officedomain) == "能源业"): ?>selected="selected"<?php endif; ?>>能源业</option>
									<option value="金融/法律" <?php if(($officedomain) == "金融/法律"): ?>selected="selected"<?php endif; ?>>金融/法律</option>
									<option value="餐饮/旅馆业" <?php if(($officedomain) == "餐饮/旅馆业"): ?>selected="selected"<?php endif; ?>>餐饮/旅馆业</option>
									<option value="医疗/卫生/保健" <?php if(($officedomain) == "医疗/卫生/保健"): ?>selected="selected"<?php endif; ?>>医疗/卫生/保健</option>
									<option value="建筑工程" <?php if(($officedomain) == "建筑工程"): ?>selected="selected"<?php endif; ?>>建筑工程</option>
									<option value="农业" <?php if(($officedomain) == "农业"): ?>selected="selected"<?php endif; ?>>农业</option>
									<option value="娱乐服务业" <?php if(($officedomain) == "娱乐服务业"): ?>selected="selected"<?php endif; ?>>娱乐服务业</option>
									<option value="体育/艺术" <?php if(($officedomain) == "体育/艺术"): ?>selected="selected"<?php endif; ?>>体育/艺术</option>
									<option value="公益组织" <?php if(($officedomain) == "公益组织"): ?>selected="selected"<?php endif; ?>>公益组织</option>
									<option value="其它" <?php if(($officedomain) == "其它"): ?>selected="selected"<?php endif; ?>>其它</option>
								</select>
							</div>
							<div class="blank10"></div>
							<div class="field officecale">
								...
								<select name="officecale" id="settings-officecale">
									<option value="">请选择</option>
									<option value="10人以下" <?php if(($officecale) == "10人以下"): ?>selected="selected"<?php endif; ?>>10人以下</option>
									<option value="10-100人" <?php if(($officecale) == "10-100人"): ?>selected="selected"<?php endif; ?>>10-100人</option>
									<option value="100-500人" <?php if(($officecale) == "100-500人"): ?>selected="selected"<?php endif; ?>>100-500人</option>
									<option value="500人以上" <?php if(($officecale) == "500人以上"): ?>selected="selected"<?php endif; ?>>500人以上</option>
								</select>
							</div>
							<div class="blank10"></div>
							<div class="field position">
								<label for="settings-position"><span class="red">*</span>职位</label>
								<input value="<?php echo ($position); ?>" class="f-input" name="position" id="settings-position">
							</div>
							<div class="blank10"></div>
							<div class="field salary">
								<label for="settings-salary"><span class="red">*</span>月收入</label>
								<select name="salary" id="settings-salary">
									<option value="">请选择</option>
									<option value="1000元以下" <?php if(($salary) == "1000元以下"): ?>selected="selected"<?php endif; ?>>1000元以下</option>
									<option value="1001-2000元" <?php if(($salary) == "1001-2000元"): ?>selected="selected"<?php endif; ?>>1001-2000元</option>
									<option value="2000-5000元" <?php if(($salary) == "2000-5000元"): ?>selected="selected"<?php endif; ?>>2000-5000元</option>
									<option value="5000-10000元" <?php if(($salary) == "5000-10000元"): ?>selected="selected"<?php endif; ?>>5000-10000元</option>
									<option value="10000-20000元" <?php if(($salary) == "10000-20000元"): ?>selected="selected"<?php endif; ?>>10000-20000元</option>
									<option value="20000-50000元" <?php if(($salary) == "20000-50000元"): ?>selected="selected"<?php endif; ?>>20000-50000元</option>
									<option value="50000元以上" <?php if(($salary) == "50000元以上"): ?>selected="selected"<?php endif; ?>>50000元以上</option>
								</select>
							</div>
							<div class="blank10"></div>
							<div class="field workyears">
								<label for="settings-workyears"><span class="red">*</span>现单位工作年限</label>
								<select name="workyears" id="settings-workyears">
									<option value="">请选择</option>
									<option value="1年（含）以下" <?php if(($workyears) == "1年（含）以下"): ?>selected="selected"<?php endif; ?>>1年（含）以下</option>
									<option value="1-3年（含）" <?php if(($workyears) == "1-3年（含）"): ?>selected="selected"<?php endif; ?>>1-3年（含）</option>
									<option value="3-5年（含）" <?php if(($workyears) == "3-5年（含）"): ?>selected="selected"<?php endif; ?>>3-5年（含）</option>
									<option value="5年以上" <?php if(($workyears) == "5年以上"): ?>selected="selected"<?php endif; ?>>5年以上</option>
								</select>
							</div>
							<div class="blank10"></div>
							<div class="field workphone">
								<label for="settings-workphone"><span class="red">*</span>公司电话</label>
								<input type="text" value="<?php echo ($workphone1); ?>" class="f-input f_l f-input60" id="frphone" onkeyup="setPhone();" onblur="setPhone();">
								<span class="f_l">&nbsp;-&nbsp;</span>
								<input type="text" value="<?php echo ($workphone2); ?>" class="f-input f_l" id="numphone" onkeyup="setPhone();" onblur="setPhone();">
								<input type="hidden" value="<?php echo ($workphone); ?>" name="workphone" id="workphone">
							</div>
							<div class="blank10"></div>
							<div class="field workemail">
								<label for="settings-workemail"><span class="red">*</span>工作邮箱</label>
								<input type="text" class="f-input" value="<?php echo ($workemail); ?>" name="workemail" id="settings-workemail">
							</div>
							<div class="blank10"></div>
							<div class="field officeaddress">
								<label for="settings-officeaddress"><span class="red">*</span>公司地址</label>
								<input type="text" class="f-input f-input220" value="<?php echo ($officeaddress); ?>" name="officeaddress" id="settings-officeaddress">
							</div>
							<div class="blank10"></div>
						</td>
					</tr>
				...
				<div class="blank10"></div>
				<div class="t_name item_group" style="width:840px">直系亲属联系人<span style="font-weight:normal">（在您贷款成功后，我们会通过电话核实您的紧急联系人信息）</span></div>
				<table width="840px" class="user_info_table">
					<tr>
						<td class="pt10">
							<div class="field urgentcontact">
								<label for="settings-urgentcontact"><span class="red">*</span>姓名</label>
								<input type="text" class="f-input" value="<?php echo ($urgentcontact); ?>" name="urgentcontact" id="settings-urgentcontact">
							</div>
							<div class="blank10"></div>
							<div class="field urgentrelation">
								<label for="settings-urgentrelation"><span class="red">*</span>关系</label>
								<input type="text" class="f-input" value="<?php echo ($urgentrelation); ?>" name="urgentrelation" id="settings-urgentrelation">
							</div>
							<div class="blank10"></div>
							<div class="field urgentmobile">
								<label for="settings-urgentmobile"><span class="red">*</span>手机</label>
								<input type="text" class="f-input" value="<?php echo ($urgentmobile); ?>" name="urgentmobile" id="settings-urgentmobile">
							</div>
						</td>
					</tr>
				</table>
				<div class="blank10"></div>
				<div class="t_name item_group" style="width:840px">其他联系人</div>
				<table width="840px" class="user_info_table">
					<tr>
						<td class="pt10">
							<div class="field urgentcontact2">
								<label for="settings-urgentcontact2"><span class="red">*</span>姓名</label>
								<input type="text" class="f-input" value="<?php echo ($urgentcontact2); ?>" name="urgentcontact2" id="settings-urgentcontact2">
							</div>
							<div class="blank10"></div>
							<div class="field urgentrelation2">
								<label for="settings-urgentrelation2"><span class="red">*</span>关系</label>
								<input type="text" class="f-input" value="<?php echo ($urgentrelation2); ?>" name="urgentrelation2" id="settings-urgentrelation2">
							</div>
							<div class="blank10"></div>
							<div class="field urgentmobile2">
								<label for="settings-urgentmobile2"><span class="red">*</span>手机</label>
								<input type="text" class="f-input" value="<?php echo ($urgentmobile2); ?>" name="urgentmobile2" id="settings-urgentmobile2">
							</div>
						</td>
					</tr>
				</table>
				<div class="blank"></div>
				<div class="clearfix b" style="padding: 10px 90px">请确保您填写的资料真实有效，所有资料将会严格保密。一旦被发现所填资料有虚假，将会影响您在p2p信贷的信用，对以后借款造成影响。</div>
					
				<div class="blank"></div>
				<div class="act mt10 mb10 tc">
						<input type="hidden" value="<?php echo ($uid); ?>" name="uid" />
						<input type="submit" class="sub_btn" id="settings-submit" name="commit" value="保存">
				</div>
				<div class="blank"></div>
		</div>
...
function setPhone(){
	...
	if(frphone!=""&&numphone!=""){
		$("#workphone").val(frphone+"-"+numphone);
	}
	else{
		$("#workphone").val("");
	}
