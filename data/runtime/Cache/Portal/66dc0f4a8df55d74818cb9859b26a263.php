...
<div class="wrap" style="width:1143px;">
	<div class="blank"></div>
	<div style="font-size:12px; color:#333; height:40px; width:1057px;  line-height:40px;">
		当前位置 : <a href="/index.php">首页</a> > <a href="/index.php/portal/list/index">资讯中心</a> > <a href="/index.php/portal/list/index/id/<?php echo ($mbx["term_id"]); ?>"><?php echo ($mbx["name"]); ?></a>
	</div>
		<!--<div class="wrap">
		<div class="blank"></div>
		<div class="short wb f_l">
			...
			<div class="inc_main cf">
				<div class="relate_help clearfix">
							...
							<dt ><?php echo ($ClassName); ?></dt>
							 <?php if(is_array($SubClass)): $i = 0; $__LIST__ = $SubClass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd <?php if($vo['tid'] == $tid): ?>class="act"<?php endif; ?> ><a href="<?php echo U('Article/index',array('id'=>$vo['tid']));?>"><?php echo ($vo["post_title"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="long help_long wb f_r" style="width:1100px;">
			
			<div class="inc_main" style="padding:36px 50px">
				<div class="article_title f16 b tc pt10">
					 <?php echo ($post_title); ?>	</div>
				<div class="publish_time bbd clearfix pr">
				<?php echo ($post_modified); ?><!--<?php echo ($user_nicename); ?>-->&nbsp;  点击数：<?php echo ($post_hits); ?>
								<div class="f_r ps" style="right:0; top:5px"><a href="javascript:window.history.back();">[返回]</a></div>
				</div>
