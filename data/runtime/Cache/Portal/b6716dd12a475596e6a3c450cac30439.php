		...
		<div class="relate_help clearfix">
			<dl class="bdd">
					<dt style="height: 10px;">
                     ...
                     <?php if(is_array($navlist)): $i = 0; $__LIST__ = $navlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['term_id'] != 17): ?><dd <?php if($vo['term_id'] == $term_id): ?>class="act"<?php endif; ?> >
								<a href="<?php echo U('portal/list/index',array('id'=>$vo['term_id']));?>"><?php echo ($vo["name"]); ?></a>
...
.alist a{ background: url("/tpl/simplebootx/Public/images/zgiy.png") no-repeat left center; padding-left:20px;}
.alist a:hover{  color:#FF0000; }
.alist span{ display:block; float:right; margin-right:30px;}
.page{ margin-top:50px; text-align:center;}
</style>
<div class="article_title f16 b tc pt10" style="width: 100px; height: 32px; text-align: center; position: relative; background-color: #FFF; top: 16px; font-size: 16px; line-height: 32px; float: left; left: 29px;"><?php echo ($name); ?> </div>
<div class="long help_long wb f_r" style="width:938px;">
	<div class="inc">
	...
	<div class="inc_main" style="padding:0 1px">
		...
		<div class="article_info">
				...
				<?php if(is_array($article)): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="alist"><span> <?php echo ($vo["post_modified"]); ?></span>	<a href="<?php echo U('portal/article/index',array('id'=>$vo['tid'],'tid'=>$vo['term_id']));?>"><?php echo ($vo["post_title"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
