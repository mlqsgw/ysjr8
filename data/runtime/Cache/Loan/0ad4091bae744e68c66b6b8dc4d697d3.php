...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     <li class="active"><a href="<?php echo U('Loan/Loanlistadmin/index');?>">所有借款</a></li>
        ...
        <thead>
        	...
        	<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
		            ...
		            <td>
                        ...
                        <a href="javascript:open_iframe_dialog('<?php echo U('Loan/Loanlistadmin/loanloadlist',array('loan_id'=>$vo['id']));?>','投标列表')">投标列表</a>|
		            	<a href="<?php echo U('Loan/Loanlistadmin/edit',array('loan_id'=>$vo['id']));?>">修改</a>|
...
function del(i){
	...
	var url='<?php echo U("loan/loanlistadmin/del");?>'+'/del/1/id/'+i;
	if(mes){
