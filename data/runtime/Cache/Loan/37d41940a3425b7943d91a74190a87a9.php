...
<div class="wrap" style="width:1143px;">
	<p class="pos"><a href="/">首页</a> > <a href="<?php echo UU('loan/index/transfer');?>">转让列表</a></p>
	...
	<div id="content" class="clearfix">
		...
		<div class="list">
			<div class="list_title clearfix">
				<div onclick="window.location.href='<?php echo UU('loan/index/lists');?>'">投资列表</div>
				<div class="cur">债权转让</div>
				<!--<a href="/index.php/loan/Borrow/inapply" class="calt">理财计算器</a>-->
			</div>
			<div class="list_cont">
				<div class="i_deal_list clearfix">
				<?php if(($cate_id) > "0"): ?><div class="clearfix"><img src="/tpl/simplebootx/Public/images/cate_top_<?php echo ($cate_id); ?>.jpg"></div><?php endif; ?>
				

             <?php if(!empty($transfer_list)): ?><table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<?php if(is_array($transfer_list)): $i = 0; $__LIST__ = $transfer_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$deal): $mod = ($i % 2 );++$i;?><tr class="item <?php if(($mod) == "1"): ?>item_1<?php endif; ?> tc">
		                <td>
		                	&nbsp;&nbsp;<img src="/tpl/simplebootx/Public/images/<?php if(($deal["warrant"]) == "0"): ?>dan0.png<?php else: ?>dan1.png<?php endif; ?>" width="24" height="24" class="ico" />
		                ...
		                <td>
							<div class="f_gray">
	                          <a href="<?php echo ($deal["user"]["url"]); ?>" target="_blank"><?php echo ($deal["user_name"]); ?></a>
	                      	</div>
		                ...
		                <td>
		                    <a href="<?php echo ($deal["duser"]["url"]); ?>" target="_blank"><img src="<?php echo ($deal["level_img"]); ?>" width="40" align="absmiddle" alt="<?php echo ($deal["duser"]["point_level"]); ?>" title="<?php echo ($deal["duser"]["point_level"]); ?>"></a>
		                </td>
		                <td>
