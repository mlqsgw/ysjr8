...
<div class="wrap J_check_wrap">
  ...
  <form class="form-horizontal J_ajaxForm" action="<?php echo U('Loan/Loanlistadmin/NewAdd_two');?>" method="post" id="myform">
  <div class="table_full">
    ...
    $(function(){
        ...
        $('#nextstep').click(function(){
           ...
           if(userid==""){
            ...
            $.post("<?php echo U('Loan/Loanlistadmin/Newcheck_loan');?>",{user:userid,loan_cate:loan_cate},function(data){
                if (data.state === 'success') {
