...
<body>
<script type="text/javascript" src="/ysjr8/tpl/simplebootx/Public/js/jquery.js"></script> 
...
<div class="header" id="header" style="position:relative; z-index:2;">
  <div class="constr">
    <div class="wrap clearfix" style="overflow:visible;">
      <div class="f_l"> <img src="/ysjr8/tpl/simplebootx/Public/images/tel.png"/ style="float:left; margin-top:5px;"> <span>客服电话:</span><span style=" font-style:italic;color:#CCC;">0371-63225933</span> 
        <!--<div class="sharemk">
	...
	var hide_menu = null;
		$("#J_account").hover(function(){
          ...
          <span class="li" rel=''> <a <?php if($Think.CONTROLLER_NAME == 'Xszy'){echo 'class="current"';}?> href="<?php echo U('Loan/xszy/index');?>" >新手指引</a> </span><span class="li">|</span> 
          <span class="li"><a href="/ysjr8/index.php/loan/Borrow/inapply">理财计算器</a></span> <span class="li">|</span> <span class="li"><a href="<?php echo U('User/register/index');?>">注册</a></span> <span class="li">|</span> <span class="li"><a href="<?php echo U('User/Login/index');?>">登录</a></span><?php endif; ?>
  ...
  <div class="main_bars">
    <div class="main_bar wrap">
      <div class="logo mr15"> <a class="link f_l" href="/ysjr8/"> <img src="/ysjr8/4cdd501dc023b.png" alt=""/> </a> </div>
      <ul class="main_nav">
        <li class="" rel=''> <a href="/ysjr8/" >首页</a> </li>
        <li class="" rel=''> <a <?php if($Think.CONTROLLER_NAME == 'Index'){echo 'class="current"';}?> href="<?php echo U('Loan/index/lists');?>"  onmouseover="mopen('m1')" onmouseout="mclosetime();">我要投资</a><img src="/ysjr8/tpl/simplebootx/Public/images/jt1.png"/ style="padding-top:30px;padding-left: 4px; float:right;"/>
        ...
        <li class="" rel=''> <a <?php if($Think.CONTROLLER_NAME == 'Borrow'){echo 'class="current"';}?>  href="<?php echo U('Loan/borrow/index');?>" onmouseover="mopen('m3')" onmouseout="mclosetime();">我要融资</a><!-- <img src="/ysjr8/tpl/simplebootx/Public/images/jt1.png"/ style="padding-top:30px;padding-left: 4px; float:right;"/>
        ...
        <li class="" rel=''> <a href="<?php echo U('User/center/index');?>"  onmouseover="mopen('m2')" onmouseout="mclosetime();"  ><!--<img src="/ysjr8/tpl/simplebootx/Public/images/tx.png"/ style="padding-top:15px; padding-right:10px; float:left;" >-->个人中心</a>
...
<div class="wrap" style="width:1143px;">
	<p class="pos"><a href="/ysjr8/">首页</a> > <a href="<?php echo UU('loan/index/lists');?>">投资列表</a></p>
	<div id="content" class="clearfix">
			...
			<div class="bddf clearfix" id="deallist" name="deallist">
				...
				<div class="propAttrs clearfix pr" id="search_condition" style="height:130px">
		            ...
		            <form action="">
						...
						<?php if(!empty($cate_list)): ?><div class="attr">
		                    <div class="attrKey">认证标识：</div>
		                    <div class="attrValues">
								<ul class="av-collapse" id="dashboard">

                                    <?php if(is_array($cate_list)): foreach($cate_list as $key=>$loan_cate): ?><li >
										<a href="<?php echo ($loan_cate["url"]); ?>#deallist" <?php if(($loan_cate["id"]) == $loan_cate_c): ?>class="cur"<?php endif; ?>><?php echo ($loan_cate["cat_name"]); ?></a>
						...
						<div class="attr">
							...
							<div class="attrValues">
								<ul class="av-collapse" name="interest" id="months">
                                    <?php if(is_array($months_type)): foreach($months_type as $key=>$months): ?><li >
                                    <a href="<?php echo ($months["url"]); ?>#deallist" <?php if(($months["id"]) == $months_type_c): ?>class="cur"<?php endif; ?>><?php echo ($months["name"]); ?></a>
                                        </li ><?php endforeach; endif; ?>
		                        </ul>
		                    </div>
		                </div>
						<div class="attr">
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" id="dashboard">
                                    ...
                                    <?php if(is_array($deal_status)): foreach($deal_status as $key=>$status): ?><li >
										<a href="<?php echo ($status["url"]); ?>#deallist" <?php if(($status["id"]) == $deal_status_c): ?>class="cur"<?php endif; ?> ><?php echo ($status["name"]); ?></a>
									</li><?php endforeach; endif; ?>
						...
						<div class="attr">
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" name="level" id="level">
                                    ...
                                    <?php if(is_array($user_level)): foreach($user_level as $key=>$ilevel): ?><li>
									   <a href="<?php echo ($ilevel["url"]); ?>#deallist" <?php if(($user_level_c) == $ilevel["id"]): ?>class="cur"<?php endif; ?>><?php echo ($ilevel["name"]); if(($ilevel["id"]) > "0"): ?>以上<?php endif; ?></a>
								   </li><?php endforeach; endif; ?>
								</ul>
							</div>
		                </div>
						<div class="attr">
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" name="interest" id="interest">
                                    ...
                                    <?php if(is_array($year_rate)): foreach($year_rate as $key=>$iinterest): ?><li>
									   <a href="<?php echo ($iinterest["url"]); ?>#deallist" <?php if(($year_rate_c) == $iinterest["id"]): ?>class="cur"<?php endif; ?>><?php echo ($iinterest["name"]); if(($iinterest["id"]) > "0"): endif; ?></a>
								   </li><?php endforeach; endif; ?>
		                        </ul>
		                    </div>
		                </div>
						...
						<div class="attr">
		                    ...
		                    <div class="attrValues">
								<ul class="av-collapse" name="lefttime" id="lefttime">
                                    ...
                                    <?php if(is_array($lefttime)): foreach($lefttime as $key=>$ilefttime): ?><li>
									   <a href="<?php echo ($ilefttime["url"]); ?>#deallist" <?php if(($lefttime_c) == $ilefttime["id"]): ?>class="cur"<?php endif; ?>><?php echo ($ilefttime["name"]); if(($ilefttime["id"]) > "0"): endif; ?></a>
								   </li><?php endforeach; endif; ?>
		                        </ul>
		                    </div>
		                </div>
		...
		<div class="list">
			<div class="list_title clearfix">
				...
				<div class="list2" onclick="window.location.href='<?php echo UU('loan/index/transfer');?>'">债权转让</div>
				<!--<a href="/ysjr8/index.php/loan/Borrow/inapply" class="calt">理财计算器</a>-->
			</div>
			<div class="list_cont">
							...
							<?php if(is_array($deal_list)): $key = 0; $__LIST__ = $deal_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$deal): $mod = ($key % 2 );++$key;?><tr class="item <?php if(($mod) == "1"): ?>item_1<?php endif; ?>" >
								...
								<td>
                                    ...
                                    <?php if($deal["deal_status"] == 0): ?>class="f_white"
                                        ...
                                        >
                                       <?php if(($deal["is_wait"]) == "1"): ?>等等开始<?php else: ?> <?php echo (loan_state($deal["deal_status"])); endif; ?>
                                        </span>
