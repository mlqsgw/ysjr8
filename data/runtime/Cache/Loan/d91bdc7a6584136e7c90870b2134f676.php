...
<link href="/tpl/simplebootx/Public/css/jiameng.css" rel="stylesheet" type="text/css" />
...
<div class="jiamengwrap" style="margin-top:20px; z-index:1;" >
            ...
            <div class="relate_help clearfix">
                <dl class="bdd" >
                        <dt >加入帮助
                         ...
                         <?php if(is_array($bz)): $i = 0; $__LIST__ = $bz;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd><a href="<?php echo U('portal/article/index',array('id'=>$vo['tid'],'tid'=>10));?>"><?php echo ($vo["post_title"]); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>							
                </dl>
            </div>
        </div>	
        </div>
  ...
  <div class="jiamengkehu" >
     ...
     <?php if(is_array($jm)): $i = 0; $__LIST__ = $jm;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jm): $mod = ($i % 2 );++$i;?><div class="kehu_info" style="border-right:1px solid #f0f0f0;">
            <div class="kehu_logo">
             <span><img src="/Uploads<?php echo ($jm["jm_img"]); ?>" /></span>
            </div>
            <div class="kehu_jianjie">
              <h4><?php echo ($jm["jm_title"]); ?></h4>
              <p><?php echo mb_substr($jm['jm_small'],0,40,'utf-8'); if(mb_strlen($jm['jm_small'],'utf-8')>30){ echo "..."; } ?></p>
              <a href="/index.php/loan/jm/jmcon/id/<?php echo ($jm["jm_id"]); ?>">查看详情 </a>
            </div>
            <div class="clear"></div>
