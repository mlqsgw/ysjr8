...
class HomeBaseController extends AppframeController {
	...
	public function __construct() {
		...
		parent::__construct();
		$this->assign("about",$this->get_article(6));//关于我们
		$this->assign("help",$this->get_article(7));//使用帮助
		$this->assign("Understanding",$this->get_article(8));//了解
		$this->assign("safe",$this->get_article(9));//安全保护
