...
//提醒配置
if(file_exists("data/conf/remind.php")){
    $remind=include "data/conf/remind.php";
}else{
    $remind=array();
}
//参数配置
if(file_exists("data/conf/param.php")){
    $param=include "data/conf/param.php";
}else{
    $param=array();
}
$configs= array(
		...
		'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Comment','Loan','App'),
 		'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题
 		'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀
		'DEFAULT_MODULE'        =>  'Loan',  // 默认模块
...
return  array_merge($configs,$db,$runtime_config,$remind,$param);
