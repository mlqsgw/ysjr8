...
class SettingController extends AdminbaseController{
	...
	function site(){
		//$imgurl="./data/upload/54adfc45d3745.jpg";
		//water($imgurl);
		...
		//水印的位置
		$SYLocation=array(1=>"左上角",2=>"上居中",3=>"右上角",4=>"左居中",5=>"居中",6=>"右居中",7=>"左下角",8=>"下居中",9=>"右下角");
		$waterposition=C("con_watermark_position");
		$waterposition=empty($waterposition)?1:$waterposition;
		$this->assign("SYLocation",$SYLocation);
		$this->assign("con_watermark_position",$waterposition);
		$this->display();
	}
	...
	function site_post(){
		if (IS_POST) {		   
			...
			$configs['SITE_NAME']=$_POST['options']['site_name'];
			
			//水印设置
			$configs=array_merge($configs,$_POST["Img"]);
