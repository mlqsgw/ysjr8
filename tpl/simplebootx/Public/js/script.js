...
//				alert(ajaxobj.responseText);
	...
	$(".J_send_msg").bind("click",function(){
		...
		$.weeboxs.open("/index.php?g=Loan&m=index&a=send_msg&user_id="+user_id, {contentType:'ajax',showButton:false,title:"发送站内消息",width:560,height:200,type:'wee'});
	});
...
{
	var ajaxurl = "/ptop/index.php?g=User&m=Myaccount&a=authma";
	$.ajax({ 
		url: ajaxurl,
		dataType: "json",
		success: function(obj){
...
{	
	$.weeboxs.open(APP_ROOT+"/index.php?ctl=ajax&act=ajax_login", {contentType:'ajax',showButton:false,title:'用户登录',width:570,type:'wee',onclose:func});
}
